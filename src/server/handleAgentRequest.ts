      ...
      parameters: {
        ...
        properties: {
          ...
          target: {
            type: "number",
            description:
              "Required (and must be > 0) when completionType is value or timer: the numeric goal (value) or goal duration in minutes (timer). If the user hasn't stated a specific amount, ask for one rather than omitting this.",
          },
          unit: {
            type: "string",
      ...
      parameters: {
        ...
        properties: {
          ...
          newTarget: {
            type: "number",
            description:
              "Required (and must be > 0) when newCompletionType switches to value or timer: the numeric goal (value) or goal duration in minutes (timer). Also used to change an existing value/timer habit's goal.",
          },
          newUnit: {
            type: "string",
            description: "Used when completionType is value: a short label for the number, e.g. \"glasses\", \"pages\", \"reps\".",
